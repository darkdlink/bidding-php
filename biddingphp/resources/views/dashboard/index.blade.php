...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            ...
            @can('scrape-biddings')
            <a href="{{ route('biddings.scrape.form') }}" class="btn btn-sm btn-secondary shadow-sm ml-2">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('biddings.index') }}" method="GET" class="form-inline">
                ...
                <a href="{{ route('biddings.index') }}" class="btn btn-secondary mb-2 ml-2">Limpar</a>
            </form>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        // Ativa a biblioteca Select2 para melhorar a usabilidade dos selects
